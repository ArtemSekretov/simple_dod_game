...
bullets_draw(BulletsDrawContext *context)
{
    ...
    u32 draw_count = min(kBulletsUpdateSourceBulletsMaxInstanceCount, spawn_count);
    ...
    for (u32 bullet_instance_index = 0; bullet_instance_index < draw_count; bullet_instance_index++)
    {
